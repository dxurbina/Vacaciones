...
class LoadController{
    ...
    public function load(){
        ...
        if($this->flag == true || (isset($_SESSION['nickname']) and $_SESSION['access'] == 1 || $_SESSION['access'] == 3 || $_SESSION['access'] == 4 || $_SESSION['access'] == 5)){
            $this->Load->LoadType($this->obj);
            $this->Load->GeneralData();
    ...
    public function verify(){
        if(isset($_SESSION['nickname']) and $_SESSION['access'] == 3 || $_SESSION['access'] == 4 || $_SESSION['access'] == 5){
           ...
           // $json_str = $_POST['id'];
            ...
            $_array = $this->Load->verify($json_obj->pass);
